                ...
                <div>
                  ...
                  <div class="link-group d-flex flex-row flex-start">
                    <div class="contact-stack">
                      ...
                      <a
                        href="https://maps.app.goo.gl/7ZXUGZdNgvHQ3N988"
                        target="_blank"
                    ...
                    <div class="social-stack">
                      <a
                        href="https://www.facebook.com/profile.php?id=100063491955651#"
                      ...
                      <a
                        href="https://x.com/GolfCopperRidge"
                        class="social-link link"
                        target="_blank"
                      >
                        <img
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="copyright-wrapper">
                    <div class="new-row">
                      <p>
                        © Copper Ridge Golf Club ${new Date().getFullYear()} | Wink Entertainment, LLC
                      </p>
                    </div>
                    <a
